...
Start_SSR(){
	check_pid
	wget -q -O /etc/init.d/ssrmu "https://raw.githubusercontent.com/egirahmadi/air/main/ssrmu"
...
Install_SSR
wget -q -O /usr/bin/ssr https://raw.githubusercontent.com/egirahmadi/air/main/ssrmu.sh && chmod +x /usr/bin/ssr
wget -q -O /usr/bin/add-ssr https://raw.githubusercontent.com/egirahmadi/air/main/add-ssr.sh && chmod +x /usr/bin/add-ssr
wget -q -O /usr/bin/del-ssr https://raw.githubusercontent.com/egirahmadi/air/main/del-ssr.sh && chmod +x /usr/bin/del-ssr
wget -q -O /usr/bin/renew-ssr https://raw.githubusercontent.com/egirahmadi/air/main/renew-ssr.sh && chmod +x /usr/bin/renew-ssr
