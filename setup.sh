...
wget -q https://raw.githubusercontent.com/egirahmadi/air/main/cf.sh && chmod +x cf.sh && ./cf.sh
#install ssh ovpn
wget -q https://raw.githubusercontent.com/egirahmadi/air/main/ssh-vpn.sh && chmod +x ssh-vpn.sh && screen -S ssh-vpn ./ssh-vpn.sh
