...
#input perintah sstp
wget -q -O /usr/bin/add-sstp https://raw.githubusercontent.com/egirahmadi/air/main/add-sstp.sh && chmod +x /usr/bin/add-sstp
wget -q -O /usr/bin/del-sstp https://raw.githubusercontent.com/egirahmadi/air/main/del-sstp.sh && chmod +x /usr/bin/del-sstp
wget -q -O /usr/bin/cek-sstp https://raw.githubusercontent.com/egirahmadi/air/main/cek-sstp.sh && chmod +x /usr/bin/cek-sstp
wget -q -O /usr/bin/renew-sstp https://raw.githubusercontent.com/egirahmadi/air/main/renew-sstp.sh && chmod +x /usr/bin/renew-sstp
rm -f /root/sstp.sh
